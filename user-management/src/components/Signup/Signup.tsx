    ...
    return (
        <div className='flex bg-white rounded-xl mx-2 h=[40vh]  md:w-[100vh] drop-shadow-2xl'>
                ...
                <form action="">
                    ...
                    <div className="inputGroup py-2">
                        ...
                        <div className='flex py-1 px-4 rounded-full border-2 bg-blue-100'>
                            ...
                            <input name='name' type="text" className='ms-2 bg-inherit w-11/12 outline-0 ' placeholder='Enter Name' />
                        </div>
                    </div>
                    <div className="inputGroup py-2">
                        <p>Email</p>
                        <div className='flex py-1 px-4 rounded-full border-2 bg-blue-100'>
                            ...
                            <input name='email' type="email" className='ms-2 bg-inherit w-11/12 outline-0 ' placeholder='Enter Email' />
                        </div>
                    </div>
                    <div className="inputGroup py-2">
                        <p>Phone No.</p>
                        <div className='flex py-1 px-4 rounded-full border-2 bg-blue-100'>
                            ...
                            <input name='phoneno' type="number" className='ms-2 bg-inherit w-11/12 outline-0 ' placeholder='Enter Phone number' />
                        </div>
                    </div>
                    <div className="inputGroup py-2">
                        <p>Password</p>
                        <div className='flex py-1 px-4 rounded-full border-2 bg-blue-100'>
                            ...
                            <input name='password' type="password" className='ms-2 bg-inherit w-11/12 outline-0 ' placeholder='Enter Password' />
                        </div>
                    </div>
                    <div className="inputGroup py-2">
                        ...
                        <div className='flex py-1 px-4 rounded-full border-2 bg-blue-100'>
                            <img className='w-5' src="/img/Login/lock.svg" alt="" />
                            <input name='confirmpassword' type="password" className='ms-2 bg-inherit w-11/12 outline-0 ' placeholder='Confirm Password' />
                        </div>
                    </div>
                    <div className="inputGroup py-2">
            ...
            <div className='w-1/2 bg-[#005ae6] rounded-r-xl  hidden md:flex'>
                <div className=' px-4 py-7 text-right'>
